	...
	return [
		...
		},
		{
			...
			text: {
				type: 'mrkdwn',
				text:
					"Great to see you here! *<https://github.com/rishiosaur/paevik|Paevik>* is a simple journalling bot for Slack. It looks like you're writing your first entry, so here's a summary of what entries mean and what you can do:",
			},
		},
		{
			type: 'section',
		...
		},
		{
			...
			text: {
				type: 'mrkdwn',
				text:
					"Let's set that up after you write your first entry. Go ahead! I can't wait to see it :smile:",
			},
		},
	]
}
